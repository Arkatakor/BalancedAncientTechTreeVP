...
UPDATE Builds SET PrereqTech = 'TECH_HORSEBACK_RIDING' WHERE Type = 'BUILD_TRADING_POST' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_TERRAIN' AND Value= 1 );
